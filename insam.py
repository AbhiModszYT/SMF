...
print(detect_color+'''
                           ...
                           $$$$.e$"  .
                           "$$$$$"   "
     (ins Brute-force by AMBOT 8.1v)        $$$$c  /
        .                   $$$$$$$P
       ."c                      $$$
      .$c3b                  ..J$$$$$e
      4$$$$             .$$$$$$$$$$$$$$c
...
print ('''
==============================================
[developer] => AMBOT - 0xfff0800 [developer_TG_Channel] => @AMBOTYT ) 
[developer_TG_ID] => @AM_YTBOTT
==============================================
''')
...
flo = input ("List Of Passwords use (pass.txt) FOR none Passwords / (pass1.txt)  FOR 1k Passwords / (pass2.txt) FOR 10K Passwords / (pass3.txt) FOR 1Million Passwords => ")
linux = 'clear'
windows = 'cls'
